...
This chapter is a work in progress for now and will be
published once it'll be ready.

To make it happen a bit sooner, you can send some encouraging
words to ivan.appel@gmail.com, or you can also send some
encouraging money using the "Donate" button below, or both.

[![Donate](https://www.paypalobjects.com/en_US/i/btn/btn_donate_SM.gif)](https://www.paypal.com/donate?hosted_button_id=5GNRHRET3USG2)
